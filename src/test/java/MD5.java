...
public class MD5 {
    ...
    public static void main(String[] args) {
        String str = "123";
        for (int i = 0; i < 3; i++) {
            str = MD5.encode(str + "shiro");
        }
        System.out.println(str);
        ByteSource salt2 = ByteSource.Util.bytes("shiro");
        ByteSource salt = ByteSource.Util.bytes("shiro");
        SimpleHash md5 = new SimpleHash("MD5", "123", salt, 1);
        System.out.println(MD5.encode("123" + "shiro"));
